...
// //           )}
// //           {isDropdownVisible && <LoginPopup onClose={() => setIsLoginVisible(false)} />}
// //         </div>
// //         {/* Settings Icon */}
...
//       </div>
//       <div className="flex items-center space-x-2">
//         <div className="bg-black rounded-3xl relative" onClick={() => setIsLoginVisible(true)}>
//           {userProfilePicture ? (
//             <Image
//               src={userProfilePicture}
//               alt="Profile"
...
//           )}
//         </div>
//         {isLoginVisible && <LoginPopup onClose={() => setIsLoginVisible(false)} />}
